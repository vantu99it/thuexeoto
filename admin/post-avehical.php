...
?>
	...
	<head>
		...
		<title>Trang quản trị | Đăng xe</title>
											...
											<div class="form-group">
												<div class="col-sm-3">
													<div class="checkbox checkbox-inline">
														...
														<label for="airconditioner"> Điều hòa </label>
													</div>
												</div>
												<div class="col-sm-3">
													<div class="checkbox checkbox-inline">
														<input type="checkbox" id="powerdoorlocks" name="powerdoorlocks" value="1">
														<label for="powerdoorlocks"> Khóa điện </label>
													</div>
												</div>
												<div class="col-sm-3">
													<div class="checkbox checkbox-inline">
														<input type="checkbox" id="antilockbrakingsys" name="antilockbrakingsys" value="1">
														<label for="antilockbrakingsys"> Hệ thống chống khóa phanh </label>
													</div>
												</div>
												<div class="checkbox checkbox-inline">
											...
											<div class="form-group">
												...
												<div class="col-sm-3">
													<div class="checkbox checkbox-inline">
														...
														<label for="driverairbag">Túi khí tài xế</label>
													</div>
												</div>
												<div class="col-sm-3">
													<div class="checkbox checkbox-inline">
											...
											<div class="form-group">
												<div class="col-sm-3">
													<div class="checkbox checkbox-inline">
														...
														<label for="cdplayer"> Máy nghe nhạc </label>
													</div>
												</div>
												<div class="col-sm-3">
