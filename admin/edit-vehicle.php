								...
								<div class="col-md-12">
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<?php if ($msg) { ?><div class="succWrap"><strong>Thành công</strong>:<?php echo htmlentities($msg); ?>
												</div><?php } ?>
											<?php
											$id = intval($_GET['id']);
												...
												<div class="col-sm-3">
													<?php if ($result->AirConditioner == 1) { ?>
														<div class="checkbox checkbox-inline">
															...
															<label for="inlineCheckbox1"> Điều hòa </label>
														</div>
													<?php } else { ?>
														<div class="checkbox checkbox-inline">
												...
												<div class="col-sm-3">
													<?php if ($result->PowerDoorLocks == 1) { ?>
														<div class="checkbox checkbox-inline">
															...
															<label for="inlineCheckbox2"> Khóa điện </label>
														</div>
													<?php } else { ?>
												...
												<div class="col-sm-3">
													<?php if ($result->AntiLockBrakingSystem == 1) { ?>
														<div class="checkbox checkbox-inline">
															...
															<label for="inlineCheckbox3"> Hệ thống chống bó cứng phanh ABS </label>
														</div>
													<?php } else { ?>
														<div class="checkbox checkbox-inline">
																		...
																		<div class="col-sm-3">
																			...
																			?>
																				<div class="checkbox checkbox-inline">
																					...
																					<label for="inlineCheckbox1"> Máy nghe nhạc </label>
																				</div>
																			<?php } else { ?>
																				<div class="checkbox checkbox-inline">
																		...
																		<div class="col-sm-3">
																			...
																			?>
																				<div class="checkbox checkbox-inline">
																					...
																					<label for="inlineCheckbox3"> Cảm biến sự cố </label>
																				</div>
																			<?php } else { ?>
																				<div class="checkbox checkbox-inline">
