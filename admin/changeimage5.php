...
<head>
	...
	<title>Trang quản trị | Cập nhật hình ảnh 5</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Hình ảnh 5 </h2>
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										...
										<?php 
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Cập nhật hình ảnh 5<span style="color:red">*</span></label>
												<div class="col-sm-8">
