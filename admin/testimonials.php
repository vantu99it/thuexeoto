												...
												foreach ($results as $result) {				?>
													<tr>
														...
														<td><?php if ($result->status == "" || $result->status == 0) {
															?><a href="testimonials.php?aeid=<?php echo htmlentities($result->id); ?>" onclick="return confirm('Bạn có thực sự muốn kích hoạt')"> Không hoạt động</a>
															<?php } else { ?>

																<a href="testimonials.php?eid=<?php echo htmlentities($result->id); ?>" onclick="return confirm('Bạn có thực sự muốn không kích hoạt')"> Hoạt động</a>
														</td>
													<?php } ?></td>
													</tr>
											<?php $cnt = $cnt + 1;
